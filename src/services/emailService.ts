...
class EmailService {
  ...
  constructor() {
    // ENABLE email functionality with Gmail SMTP
    this.emailEnabled = true; // Set to true to enable Gmail SMTP
    ...
    this.config = {
      ...
      auth: {
        user: 'fxgold.info@gmail.com', // Your Gmail account
        pass: 'svlw ypaq dqlv vzqz' // Your Gmail App Password
      }
    };
  }
